 ...
 */
public class PhaseValues implements RobotMapper<List<Double>> {
  ...
  @Override
  public Function<List<Double>, Robot<?>> apply(Grid<? extends SensingVoxel> body) {
    return values -> {
  ...
  @Override
  public List<Double> example(Grid<? extends SensingVoxel> body) {
