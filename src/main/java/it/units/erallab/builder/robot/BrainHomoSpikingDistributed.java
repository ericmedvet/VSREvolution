 ...
 * @author giorgia
 */
public class BrainHomoSpikingDistributed implements NamedProvider<PrototypedFunctionBuilder<MultivariateSpikingFunction, Robot>> {

  @Override
  public PrototypedFunctionBuilder<MultivariateSpikingFunction, Robot> build(Map<String, String> params) {
