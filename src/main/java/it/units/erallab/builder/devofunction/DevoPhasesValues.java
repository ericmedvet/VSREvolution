 ...
 */
public class DevoPhasesValues implements NamedProvider<PrototypedFunctionBuilder<Grid<double[]>, UnaryOperator<Robot>>> {

  @Override
  public PrototypedFunctionBuilder<Grid<double[]>, UnaryOperator<Robot>> build(Map<String, String> params) {
