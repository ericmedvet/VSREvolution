 ...
 */
public class FunctionNumbersGrid implements NamedProvider<PrototypedFunctionBuilder<RealFunction, Grid<double[]>>> {

  @Override
  public PrototypedFunctionBuilder<RealFunction, Grid<double[]>> build(Map<String, String> params) {
