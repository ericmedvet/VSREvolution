 ...
 * @author eric
 */
public class BinaryAndDoublesStandard implements NamedProvider<SolverBuilder<Pair<BitString, List<Double>>>> {

  private final double xOverProb;
  private final double tournamentRate;
  private final int minNTournament;

  public BinaryAndDoublesStandard(double xOverProb, double tournamentRate, int minNTournament) {
