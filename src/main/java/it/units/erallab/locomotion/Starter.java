...
public class Starter extends Worker {
  ...
  public void run() {
    ...
    NamedProvider<PrototypedFunctionBuilder<?, ?>> mapperBuilderProvider = NamedProvider.of(Map.ofEntries(
        ...
        Map.entry("brainHomoSpikeDist", new BrainHomoSpikingDistributed()),
        Map.entry("brainHomoQuantSpikeDist", new BrainHomoQuantizedSpikingDistributed()),
        Map.entry("brainHeteroDist", new BrainHeteroDistributed()),
        Map.entry("brainHeteroSpikeDist", new BrainHeteroSpikingDistributed()),
        Map.entry("brainHeteroQuantSpikeDist", new BrainHeteroQuantizedSpikingDistributed()),
